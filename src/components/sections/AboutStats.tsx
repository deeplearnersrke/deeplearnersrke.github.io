      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20 text-xs font-semibold uppercase tracking-wider">
            About Deep Learners Web Agency
          </div>
          ...
          <p className="text-base sm:text-lg text-zinc-400 leading-relaxed light:text-slate-600">
            Deep Learners is a elite web development agency specializing in modern web applications, high-converting landing pages, SaaS platforms, and enterprise dashboards. We combine Silicon Valley design aesthetics with rock-solid full-stack engineering.
          </p>
        </div>
